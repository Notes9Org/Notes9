...
function SidebarProvider({
  ...
  // Close mobile drawer when route changes (e.g. user taps a nav link)
  React.useEffect(() => {
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          className="z-[120] w-(--sidebar-width) bg-sidebar p-0 text-sidebar-foreground"
          style={
            {
...
function SidebarMenuSkeleton({
  ...
  // Random width is generated only on client after mount
  const [width, setWidth] = React.useState('70%')

  React.useEffect(() => {
    // Generate random width between 50 to 90% only on client
