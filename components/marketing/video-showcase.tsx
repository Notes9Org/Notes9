      ...
      <div className="container relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <button
                ...
                className={`rounded-full border px-4 py-2 text-[16px] font-medium transition-all duration-200 cursor-pointer ${
                  on
                    ...
                    : "border-border/60 bg-background text-muted-foreground hover:border-[var(--n9-accent)]/30 hover:text-foreground"
                }`}
              >
                {slide.label}
              </button>
        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="relative lg:sticky lg:top-32 lg:col-span-7">
            ...
            <div className="group relative flex aspect-[4/3] items-center justify-center overflow-hidden rounded-2xl border border-border/40 bg-background p-2 shadow-2xl shadow-black/5 ring-1 ring-black/5 backdrop-blur-sm dark:ring-white/10 sm:p-6">
