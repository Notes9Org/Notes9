...
export function HeroAppFrame({ className }: { className?: string }) {
  return (
    ...
    >
      <div className="flex h-full min-w-[68rem]">
        <Sidebar />
        <Main />
      </div>
    </div>
...
function Sidebar() {
  return (
    <aside className="w-[15.5rem] shrink-0 border-r border-border/60 bg-background px-3 py-4">
      <div className="px-2">
        <p className="font-serif text-[19px] font-semibold leading-none tracking-tight">
          Notes9
        </p>
        <p className="mt-1 font-mono text-[8px] uppercase tracking-[0.28em] text-muted-foreground">
          Research Lab
        </p>
      </div>

      <div className="mt-4 flex items-center gap-2 rounded-lg border border-border/70 bg-muted/40 px-2.5 py-1.5">
      ...
      <div className="mt-2.5 flex items-center gap-2 rounded-lg bg-[color-mix(in_oklab,#6c8a68_18%,transparent)] px-2.5 py-2">
        <Plus className="size-3.5 text-[#4f6b4c]" />
        <span className="text-[12px] font-medium text-[#3f5a3c]">New</span>
      </div>
...
function Main() {
  return (
    <div className="min-w-0 flex-1">
      <div className="flex items-center justify-between border-b border-border/60 bg-[var(--n9-accent-light)]/60 px-6 py-2.5">
        <span className="text-[12px] text-muted-foreground">Literature</span>
        <div className="flex items-center gap-2.5">
          {[0, 1, 2].map((i) => (
            <span key={i} className="size-3.5 rounded-full bg-muted-foreground/20" />
          ))}
          <span className="size-6 rounded-md border border-[var(--n9-accent)]/40 bg-[var(--n9-accent-light)]" />
        </div>
      </div>
      ...
      <div className="px-6 py-5">
        <div className="flex items-start justify-between gap-6">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <span className="inline-flex items-center gap-1.5 rounded-lg border border-border/70 px-3 py-1.5 text-[11px] font-medium text-foreground">
              <UploadSimple className="size-3" />
              Upload PDF
            </span>
            <span className="inline-flex items-center gap-1.5 rounded-lg bg-[var(--n9-accent)] px-3 py-1.5 text-[11px] font-semibold text-white">
        ...
        <div className="mt-5 inline-flex items-center gap-1 rounded-lg border border-border/70 bg-muted/30 p-1">
          <span className="inline-flex items-center gap-1.5 rounded-md bg-background px-3 py-1.5 text-[11px] font-medium shadow-sm">
            <MagnifyingGlass className="size-3" />
            Search &amp; read
          </span>
          <span className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[11px] text-muted-foreground">
        ...
        <div className="mt-4 flex items-center gap-2 rounded-xl border border-border/70 bg-muted/25 px-3.5 py-2.5">
          <MagnifyingGlass className="size-3.5 text-muted-foreground/60" />
        ...
        <div className="mt-5 flex items-center gap-4 border-b border-border/60">
          <span className="border-b-2 border-[var(--n9-accent)] pb-2 text-[11px] font-medium">
            Search results
          </span>
          <span className="pb-2 text-[11px] text-muted-foreground">Staging</span>
        </div>

        <div className="mt-3 flex items-center gap-3">
          <span className="inline-flex items-center gap-1.5 rounded-md border border-border/70 px-2.5 py-1 text-[10px] text-muted-foreground">
            Filters
          </span>
          <span className="text-[10px] text-muted-foreground">10 papers</span>
        </div>
...
function AiOverview() {
  return (
    <div className="mt-4 rounded-xl border border-border/60 bg-card/60 p-4">
      <p className="flex items-center gap-1.5 font-mono text-[9px] uppercase tracking-[0.16em] text-[var(--n9-accent)]">
        <Sparkles className="size-3" weight="fill" />
        AI overview
      </p>
      <p className="mt-2.5 text-[11.5px] leading-[1.75] text-foreground/80">
      ...
      <div className="mt-3 flex items-center gap-2">
        <span className="rounded-md border border-border/70 px-2.5 py-1 text-[10px] text-muted-foreground">
          Show more
        </span>
        <span className="inline-flex items-center gap-1 rounded-md bg-[var(--n9-accent)] px-2.5 py-1 text-[10px] font-medium text-white">
...
function PaperResult() {
  return (
    <>
      ...
      <div className="mt-2 rounded-xl border border-border/60 bg-card/50 p-4">
        <div className="flex items-center gap-2.5">
          <span className="flex size-4 items-center justify-center rounded border border-border/70 font-mono text-[8px] text-muted-foreground">
            1
          </span>
          ...
          <span className="text-[9px] text-muted-foreground">66 citations</span>
        </div>
        <p className="mt-2 text-[12.5px] font-semibold text-[var(--n9-accent)]">
