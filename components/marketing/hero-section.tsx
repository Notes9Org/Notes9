      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mx-auto max-w-4xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <Badge variant="secondary" className="mb-6 text-[16px] font-medium glass text-solid">
            ...
            <p className="mt-6 text-[22px] text-solid sm:text-2xl text-balance font-light">
              AI that thinks with you, not just for you
            </p>

            <p className="mt-4 text-[20px] text-solid max-w-2xl mx-auto text-pretty font-light">
          ...
          >
            <Button size="lg" className="text-[20px] px-8 py-6 glass text-solid hover:bg-white/30">
            ...
            <Button
              variant="outline"
              size="lg"
              className="text-[20px] px-8 py-6 glass border-white/20 bg-transparent text-solid hover:bg-white/10"
            >
          ...
          <motion.p
            ...
            className="mt-6 text-[16px] text-solid"
          >
          ...
          <Card className="p-8 glass border-2 border-white/20 shadow-2xl">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-[16px] text-solid font-light">AI scans databases, ranks papers, generates summaries</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-[16px] text-solid font-light">Real-time reagent tracking with procurement assistance</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-[16px] text-solid font-light">Automated data processing and publication-ready graphs</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-[16px] text-solid font-light">Seamless knowledge sharing across research teams</p>
              </div>
            </div>
          </Card>
        </motion.div>
