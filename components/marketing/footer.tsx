    ...
    <footer id="contact" className="bg-foreground text-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-background/80">hello@notes9.com</span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="h-4 w-4 text-primary" />
                <span className="text-background/80">1-800-NOTES9-AI</span>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {footerLinks.product.map((link) => (
                    <li key={link.name}>
                      <a href={link.href} className="text-sm text-background/80 hover:text-primary transition-colors">
                        {link.name}
                      </a>
                    </li>
                  ))}
          ...
          {/* Newsletter */}
          <div className="lg:col-span-1">
            <h3 className="font-semibold text-background mb-4">Research Insights Newsletter</h3>
            <p className="text-sm text-background/80 mb-4">Weekly AI and research trends delivered to your inbox</p>
