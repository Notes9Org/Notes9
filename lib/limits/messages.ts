...
export const near: Record<string, LimitMessage> = {
  ...
  ai_budget_monthly: {
    title: "You're close to your monthly AI credits",
    body: "You've used most of this month's free credits. Your work is safe and the AI is still available.",
    action: 'Wrap up your most important AI work now.',
    resetHint: 'Credits refresh on the 1st.',
    icon: 'zap',
    color: 'amber',
  },
